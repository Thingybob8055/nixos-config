...
xdg.configFile."hypr/hyprland.conf".text = ''
    ...
    # $menu = rofi -show drun -show-icons -theme ~/.local/share/rofi/themes/custom-theme.rasi
    $menu = rofi -show drun -show-icons -theme ~/.local/share/rofi/themes/custom-theme.rasi  -calc-command "printf '%s' '{result}' | wl-copy"
    ...
    bind = SUPER SHIFT CTRL, S, exec, screenshot

    bind = , Print, exec, screenshot-satty-file 
    bind = SHIFT, Print, exec, screenshot-satty-file area

    #bindl = , XF86PowerOff, exec, hyprlock
    #bindl = , XF86PowerOff, exec, systemctl suspend -i

    #bindl = , switch:on:Lid Switch, exec, loginctl lock-session
    #bindl = , switch:on:Lid Switch, exec, sleep 0.5 && systemctl suspend -i
    ...
    bind = SUPER CTRL SHIFT, G, moveoutofgroup
    ...
    bind = , Escape, exec, hyprctl keyword general:col.active_border "rgba(33ccffee) rgba(00ff99ee) 45deg"
